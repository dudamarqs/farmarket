...
const initialCartItems: ProductType[] = [
  {
    ...
    price: 8.9,
    image: require("../assets/images/produtos/sabonete.webp"),
    quantity: 2,
  },
  {
    id: "h3",
    name: "Kit escova de dente Condor 2 unidades",
    price: 8.9,
    image: require("../assets/images/produtos/escovas.webp"),
    quantity: 1,
  },
];
...
const suggestedProducts = [
  ...
  {
    id: "m4_s",
    name: "Protetor Facial Needs 40g",
    price: 11.99,
    store: "Drogasil",
    time: "5-10min",
    image: require("../assets/images/produtos/protetor.webp"),
  },
  {
    id: "v1_s",
    name: "Vitamina C Redoxon 30cp",
    price: 35.0,
    store: "Drogasil",
    time: "5-10min",
    image: require("../assets/images/produtos/vitamina.webp"),
  },
];
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.storeInfo}>
          <Image
            source={require("../assets/images/drogasil.png")}
        ...
        <View style={styles.suggestedSection}>
          <Text style={styles.addMoreText}>
            Adicione mais produtos à sua sacola
          </Text>
          <FlatList
            horizontal
